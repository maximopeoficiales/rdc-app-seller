create function sp_list_order_store(vi_sucursal character varying, vi_caja character varying,
...
alter function sp_list_order_store(varchar, varchar, varchar, varchar) owner to intcouriersusr;

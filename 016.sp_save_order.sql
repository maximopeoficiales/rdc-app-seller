create function sp_save_order(ni_prospectorder integer, ni_purchasetypeid integer, vi_numberorder character varying, vi_sucursal character varying, vi_caja character varying, vi_purchasedate character varying, vi_identitdocument character varying, vi_transacsion character varying, vi_email character varying, ni_numberproducts integer, ni_numberproductsreturn integer, ni_montototal numeric, ni_montototalchange numeric, ni_estadorequest integer, vi_coordinates character varying, ni_return_method_id integer, vi_ip character varying, ni_purchase_id integer, vi_person_return integer, vi_person_first_name character varying, vi_person_last_name character varying, vi_person_identity_document character varying, vi_type_order character varying)
